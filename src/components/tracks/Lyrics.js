...
class Lyrics extends Component {
  // we only need the specific track info and lyrics
  // for this component, which is why we are setting them
  // in state for the Lyrics component and not context.js
        ...
        <>
          ...
          <ul className="list-group mt-3">
            ...
            <li className="list-group-item">
              ...
              {/* track.first_release_date is not a property of the track object at this time so I 
              couldn't utilize. Used track.updated_time which for most tracks is close to release date */}
            </li>
            <li className="list-group-item">
